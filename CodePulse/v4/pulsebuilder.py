...
if __name__ == "__main__":
    qApp = prepare_qt()
    shell_interactive = _interactive

    from src.PbWindow import PbWindow
    from src.Model import *
    pb = PbWindow()
    pb.setWindowTitle('Pulse builder');
    ...
    start_qt_loop_if_needed(redirect_stderr=True)
