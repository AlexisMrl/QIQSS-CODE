...
# def execution():
#     awg.run()
#     sweep(pulse_seq.devAmp,-0.007,0.007,101, filename='QBB24_34_single_shot_read_B_0T_10kHz_compare_%T.txt', out=rto.fetch, async=True, close_after=True,beforewait=0.1,extra_conf=comment)
...
text_file = open(r"C:\Projets\IMEC TD\Die_8_QBB06_24_3_3\2022-10-14\spin_readout\{}_comment_{}.txt".format(filename,timestr), "w")
n = text_file.write(comment)
text_file.close()
